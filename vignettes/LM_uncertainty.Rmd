...
```{r spaMM 4, fig.align = "center", fig.width = 4, fig.height = 4}
...
candidate_slope_u <- seq(0.8, 2, 0.1)
...
```{r spaMM 7, fig.align = "center", echo = FALSE, results = "hide", fig.height = 5, fig.width = 5}
library(lattice)
contourplot(logLik ~ candidate_intercept * candidate_slope, candidates, cuts = 15)
trellis.focus("panel", 1, 1) 
lpoints(mod_spaMM_ML$fixef["(Intercept)"], mod_spaMM_ML$fixef["humans_eaten"],

...
- `r .emo("info")` for things that are good to know for improving your understanding
- `r .emo("practice")` for practical advice (i.e. things you need to learn doing)
- `r .emo("nerd")` for nerdy details (i.e. things you don't need to learn, but useful for my argument)
...
- `r .emo("goal")` for goals (i.e. to highlight lists the key things you need to remember)
...
* biological questions for which the answers will require you to build liner models (LM or GLM)
...
For more advanced scatterplots, you may use the functionn `scatterplot()` from the package **{car}**:

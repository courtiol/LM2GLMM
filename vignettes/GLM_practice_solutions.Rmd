...
`r .emo("goal")` Study the influences of age, body mass index and smoking status upon the probability of being in menopause.
...
That suggests that girls too young to have periods are not being considered, which is not an issue for studying model menopause.
...
All models however may overestimate the prevalence of menaupose at young age.

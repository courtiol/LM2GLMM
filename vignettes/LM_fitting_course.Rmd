...
## You will learn in this session `r emojifont::emoji("mortar_board")`
...
## Sample and population variance `r emojifont::emoji("mortar_board")`
...
## Sample and population variance `r emojifont::emoji("eyeglasses")`
...
## Our toy dataset `r emojifont::emoji("alien")`
...
## A note on `package::fn` `r emojifont::emoji("mortar_board")`
...
## A note on the R package **{spaMM}** `r emojifont::emoji("mortar_board")`
...
## Fitting the Alien data using ```lm()``` `r emojifont::emoji("wrench")`
...
## Fitting the Alien data using ```fitme()``` `r emojifont::emoji("wrench")`
...
## Extraction of the design matrix `r emojifont::emoji("wrench")`
...
## Extraction of model parameter estimates `r emojifont::emoji("wrench")`
...
## Extraction of the error variance estimate `r emojifont::emoji("wrench")`
...
## Extraction of the residuals `r emojifont::emoji("wrench")`
...
## Extraction of the population residual variance `r emojifont::emoji("wrench")`
...
Note: `sigma` contains the standard deviation estimate for the errors, hence the transformation.
...
## Extraction of the log-likelihood `r emojifont::emoji("wrench")`
...
## Extraction of the residual sum of squares `r emojifont::emoji("wrench")`
...
## How to fit a LM without `lm()`? `r emojifont::emoji("mortar_board")`
...
## The Residual Sum of Squares (RSS) `r emojifont::emoji("mortar_board")`
...
## Home made LM fitting by OLS `r emojifont::emoji("eyeglasses")`
...
## The maximum (log-)likelihood (ML) `r emojifont::emoji("mortar_board")`
...
## Home made LM fitting by ML `r emojifont::emoji("eyeglasses")`
...
## Comparing the 3 methods on a REAL dataset `r emojifont::emoji("mortar_board")`
...
## What the statistical textbooks tell us `r emojifont::emoji("mortar_board")`
...
## `lm()`-like fitting using QR decomposition `r emojifont::emoji("mortar_board")`
...
## Actual `lm()` fitting procedure `r emojifont::emoji("mortar_board")`
...
## Dissecting the output from `lm()` `r emojifont::emoji("mortar_board")`
...
## What you need to remember `r emojifont::emoji("dart")`

...
## Fitting the Alien data using ```lm()``` `r .emo("practice")`
...
## Fitting the Alien data using ```fitme()``` `r .emo("practice")`
...
## How to fit a LM without `lm()`? `r .emo("info")`
...
## Home made LM fitting by OLS `r .emo("proof")`
...
## Home made LM fitting by ML `r .emo("proof")`

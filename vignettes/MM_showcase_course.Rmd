...
options(width = 120)
knitr::opts_chunk$set(cache = TRUE, cache.path = "./cache_knitr/MM_showcase/", fig.path = "./fig_knitr/MM_showcase/", fig.width = 5, fig.height = 5, fig.align = "center", error = TRUE)
```

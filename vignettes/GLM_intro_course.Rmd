...
You can fit hurdle models with `glmmTMB::glmmTMB()`.  **{glmmTMB}** is an extremely flexible package that is relatively similar to **{spaMM}** (more details on differences between them later).

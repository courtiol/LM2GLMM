...
tab <- rbind(Poisson = c(fit_Zpoiss$coefficients, NA, NA),
             Hurdle = unlist(fixef(fit_Zhurd1)),  ## NOTE: the hurdle part predicts the number of zeros
             ZeroInfl = unlist(fixef(fit_Zzi1)),  ## NOTE: the binary part predicts the number of zeros

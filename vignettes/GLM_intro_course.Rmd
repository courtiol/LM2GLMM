...
## A simple function to fit simple GLM numerically `r .emo("nerd")`
...
## Iterations in action `r .emo("nerd")`
...
You may try to play with parameters of the iterative algorithm (difficult):
...
You may also try other fitting methods (much easier):
...
You may also try other fitting functions (much easier):

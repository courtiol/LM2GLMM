...
output:
  ioslides_presentation:
    ...
    smaller: true
vignette: >
  %\VignetteIndexEntry{4.2 A showcase of some useful applications of mixed models (BROKEN FOR NOW)}
...
res.boot <- anova(fit_spaMM2, fit_spaMM2_H0, boot.repl = 1000)
```
...
res.boot2 <- anova(fit_spaMM3, fit_spaMM3_H0, boot.repl = 1000)
```

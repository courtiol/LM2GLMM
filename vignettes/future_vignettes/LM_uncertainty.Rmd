...
<font size = 5>  The data (non-parametric bootstrap), or estimates derived from it (parametric bootstrap) are used as approximations to the unknown distribution using a resampling procedure. </font>
...
CIboot2a <- function(rep = 100, i){
  ...
  sim.boot <- boot(data = data, statistic = refit, ran.gen = newData, i = i, R = rep, sim = "parametric")

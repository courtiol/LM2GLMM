...
* that computing residuals by simulation in the way out
...
# Residuals by simulation: the most useful ones!

## Computing residuals by simulation
...
```{r plot res Aliens2 3, fig.width = 7, fig.height = 4}
...
```{r sim overdisp}
r <- simulateResiduals(mod_poissMix, refit = TRUE, n = 1000)
...
r2 <- simulateResiduals(mod_poissMix2, refit = TRUE, n = 1000)
...
r <- simulateResiduals(mod_Zpoiss, refit = TRUE, n = 1000)
...
r <- simulateResiduals(mod_Znb, refit = TRUE, n = 1000)
testZeroInflation(r, plot = FALSE)
```

...
* become capable of tackling most chalenges brought by the analyses of real dataset
...
* You need to stop a little compulsive googling and copying of the code produced by random people and start trying to solve any R/stats problems like any other scientific problem: by combining observations and experiements (in your R console)

...
### 3. A catalogue of most useful {base} R command for this course
...
# A catalogue of most useful {base} R command for this course
...
```{r sapply}
sapply(c("alex", "olivia"), function(i) hello(who = i))
```


## An example: statistical power of a t-test

...
This traditional parameterization of ```x3``` is called the "treatment contrast". It is the easiest one to interpret.
...
Alternative parameterizations can ease convergence in GLM(M) (for continuous variables) or can allow for testing specific hypotheses (for qualitative variables).
...
## The case of polynomials: why make things more complex?

...
* how to write a linear model (using both notations)
...
Alternative parameterizations can ease convergence (for continuous variable) or can allow for testing specific hypotheses (for qualitative variables). 
...
Are these different representation equivalent?

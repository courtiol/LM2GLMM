...
(-2 * sigma2_resid * (logLik_mod - logLik_sat))  ## definition of the unscaled deviance!!!
...
backsolve(R, QTY)    ## RB = QTY, solve B for triangular matrix (more efficient than solve(R[1:2, 1:2], QTY[1:2]))

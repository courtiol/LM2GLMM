## ----setup, include=FALSE------------------------------------------------
library(LM2GLMM)
knitr::opts_chunk$set(cache = FALSE, cache.path = "./cache_knitr/Fungi/", fig.path = "./fig_knitr/Fungi/", fig.align = "center", fig.width = 5, fig.height = 5)
...
coef(lm(growth ~ species* (T36 + T38 + PT36 + PT38), data = FungiAlive))
...
det(XTX)
invXTX <- solve(XTX)
max(invXTX[upper.tri(invXTX)])
max(invXTX[lower.tri(invXTX)])

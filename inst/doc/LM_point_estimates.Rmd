...
### In LM, this is equivalent to performing the estimation by 
...
## Recovering the Residual Sum of Squares
...
### We look for the estimates yielding the maximum likelihood

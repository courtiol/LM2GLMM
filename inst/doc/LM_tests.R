...
## ----plot robustness F, fig.align = "center", fig.width = 5, fig.height = 5----
plot(ecdf(pv.F))
...
## ----plot LRT param boot, fig.align = "center", fig.width = 5, fig.height = 5----
hist(stat.rand)
...
## ----backward plot, fig.align = "center", fig.width = 4, fig.height = 4----
